...
export default class Dashboard extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      answers: this.generateChoices(questionAnswer[1], answers.length),
      correct: 0,
      total: 0
    }
  ...
  render() {
    return (<div>
      <h3>Correct: {this.state.correct}
        Incorrect: {this.state.total - this.state.correct}
        Total: {this.state.total}</h3>
